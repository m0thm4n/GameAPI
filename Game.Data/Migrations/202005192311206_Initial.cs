namespace Game.Data.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SwitchGames", "PublisherId", "dbo.Publishers");
            DropForeignKey("dbo.SwitchGames", "DeveloperId", "dbo.Developers");
            ...
            DropForeignKey("dbo.PCGames", "PublisherId", "dbo.Publishers");
            DropForeignKey("dbo.PCGames", "DeveloperId", "dbo.Developers");
            DropIndex("dbo.XboxGames", new[] { "PublisherId" });
            DropIndex("dbo.XboxGames", new[] { "DeveloperId" });
            DropIndex("dbo.IdentityUserLogins", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserClaims", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.SwitchGames", new[] { "PublisherId" });
            DropIndex("dbo.SwitchGames", new[] { "DeveloperId" });
            DropIndex("dbo.IdentityUserRoles", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRoles", new[] { "IdentityRole_Id" });
            DropIndex("dbo.PlaystationGames", new[] { "PublisherId" });
            DropIndex("dbo.PlaystationGames", new[] { "DeveloperId" });
            DropIndex("dbo.PCGames", new[] { "PublisherId" });
            DropIndex("dbo.PCGames", new[] { "DeveloperId" });
